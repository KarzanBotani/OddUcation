...
class UserProfile extends Component {
  ...
  static async getInitialProps(props) {
    console.log('usrsAddrs 5: ', props.query.address);

    const abc = await factory.methods.getProfile(props.query.address).call();
